/*
Read back all feedback parameters: position, speed, load, voltage, temperature, movement status, current;
...
Function Readxxx(ID), ID=-1 returns the FeedBack buffer parameter; ID>=0, directly returns the specified ID servo state via read instruction.
No need to call the FeedBack function.
*/
